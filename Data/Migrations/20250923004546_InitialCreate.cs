        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasGlutenFree = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CateringMenus", x => x.MenuId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresAudioVisual = table.Column<bool>(type: "bit", nullable: false),
                    RequiresDecorations = table.Column<bool>(type: "bit", nullable: false),
                    RequiresSecurity = table.Column<bool>(type: "bit", nullable: false),
                    RequiresParking = table.Column<bool>(type: "bit", nullable: false),
                    BaseAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CateringCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AdditionalServicesCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "BookingCaterings",
                columns: table => new
                {
                    BookingCateringId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    MenuId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingCaterings", x => x.BookingCateringId);
                    table.ForeignKey(
                        name: "FK_BookingCaterings_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingCaterings_CateringMenus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingCaterings_BookingId",
                table: "BookingCaterings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingCaterings_MenuId",
                table: "BookingCaterings",
                column: "MenuId");
